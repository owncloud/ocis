...
type UserSharingCS3Driver struct {
	...
	SystemUserID      string `yaml:"system_user_id" env:"OCIS_SYSTEM_USER_ID;SHARING_USER_CS3_SERVICE_USER_ID"`
	SystemUserIDP     string `yaml:"system_user_idp" env:"OCIS_URL;OCIS_SYSTEM_USER_IDP;SHARING_USER_CS3_SERVICE_USER_IDP"`
...
type PublicSharingCS3Driver struct {
	...
	SystemUserIDP     string `yaml:"system_user_idp" env:"OCIS_URL;OCIS_SYSTEM_USER_IDP;SHARING_PUBLIC_CS3_SERVICE_USER_IDP"`
