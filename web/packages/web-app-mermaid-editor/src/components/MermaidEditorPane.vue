<template>
  <div ref="editorRef" class="mermaid-editor-pane" />
</template>
  ...
  view = new EditorView({
    ...
    state: EditorState.create({
      ...
      extensions: [
        ...
        // No mermaid-specific CodeMirror language mode exists (unlike the HTML
        // editor's `@codemirror/lang-html`), so this pane stays a plain-text
        // editor: line numbers, history and bracket matching, no syntax coloring.
