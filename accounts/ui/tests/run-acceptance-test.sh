...
export CUCUMBER_OPTS="--require ${WEB_PATH}/tests/acceptance/setup.js --require /drone/src/accounts/ui/tests/acceptance/stepDefinitions --require ${WEB_PATH}/tests/acceptance/stepDefinitions"
