...
# Why exclude: --exclude-path ocis/messages/search --exclude-path ocis/services/search
# The search service is functional, but the microweb plugin (which generates web client code) cannot handle the proto3 optional syntax:
# WARN	plugin "microweb" does not support required features.
#   Feature "proto3 optional" is required by 1 file(s):
#     ocis/messages/search/v0/search.proto
#
# Rather than breaking the entire protobuf generation process, the search service is excluded from the problematic plugin while still being generated by the other plugins (go, micro, openapiv2, doc).
# TODO: find a replacement for microweb. It's used by reva in grpc
