...
FLAEX := $(GOBIN)/flaex-v0.2.1-0.20210616124044-d852b507e287
$(FLAEX): $(BINGO_DIR)/flaex.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/flaex-v0.2.1-0.20210616124044-d852b507e287"
	@cd $(BINGO_DIR) && $(GO) build -mod=mod -modfile=flaex.mod -o=$(GOBIN)/flaex-v0.2.1-0.20210616124044-d852b507e287 "github.com/owncloud/flaex"
