...
For this example, assuming version 1.4.0 of oCIS running on a Linux AMD64 host:

```console
# download
curl https://download.owncloud.com/ocis/ocis/1.4.0/ocis-1.4.0-linux-amd64 --output ocis
