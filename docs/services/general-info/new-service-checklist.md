...
- [ ] Add the service to `.drone.star` to enable CI. <!-- DRONE: obsolete after .drone.star removal; add service to GitHub Actions matrix in .github/workflows/acceptance-tests.yml instead -->
