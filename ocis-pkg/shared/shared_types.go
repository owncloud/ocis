...
type Commons struct {
	...
	SystemUserAPIKey  string          `mask:"password" yaml:"system_user_api_key" env:"OCIS_SYSTEM_USER_API_KEY" desc:"API key for all system users." introductionVersion:"pre5.0"`
