...
// MultiMemStore implements an in-memory store using multiple MemStore to provide support
...
// NewMultiMemStore create a new MultiMemStore. A new MemStore will be mapped based on the options.
