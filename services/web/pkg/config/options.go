...
type Options struct {
	...
	DisablePreviews          bool             `json:"disablePreviews,omitempty" yaml:"disablePreviews" env:"OCIS_DISABLE_PREVIEWS;WEB_OPTION_DISABLE_PREVIEWS" desc:"Set this option to 'true' to disable previews in all the different file listing views. The only list view that is not affected by this setting is the trash bin, as it does not allow previewing at all." deprecationVersion:"3.1" removalVersion:"4.0.0" deprecationInfo:"WEB_OPTION_DISABLE_PREVIEWS is being replaced by a global variable" deprecationReplacement:"OCIS_DISABLE_PREVIEWS"`
