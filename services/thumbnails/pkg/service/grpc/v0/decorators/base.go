...
// DecoratedService acting as facade, holding all the interfaces that this
...
// Decorator base type to implement the decorators. It will provide a basic implementation
...
// GetThumbnail basic implementation for the GetThumbnail (for the thumbnailssvc).
