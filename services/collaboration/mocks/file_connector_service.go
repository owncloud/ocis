...
func (_m *FileConnectorService) Lock(ctx context.Context, lockID string, oldLockID string) (*providerv1beta1.Lock, *typesv1beta1.Timestamp, error) {
	...
	var r0 *providerv1beta1.Lock
	var r1 *typesv1beta1.Timestamp
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*providerv1beta1.Lock, *typesv1beta1.Timestamp, error)); ok {
		return rf(ctx, lockID, oldLockID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *providerv1beta1.Lock); ok {
		r0 = rf(ctx, lockID, oldLockID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*providerv1beta1.Lock)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string) *typesv1beta1.Timestamp); ok {
...
func (_c *FileConnectorService_Lock_Call) Return(_a0 *providerv1beta1.Lock, _a1 *typesv1beta1.Timestamp, _a2 error) *FileConnectorService_Lock_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *FileConnectorService_Lock_Call) RunAndReturn(run func(context.Context, string, string) (*providerv1beta1.Lock, *typesv1beta1.Timestamp, error)) *FileConnectorService_Lock_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *FileConnectorService) RefreshLock(ctx context.Context, lockID string) (string, *typesv1beta1.Timestamp, error) {
	ret := _m.Called(ctx, lockID)
	...
	var r1 *typesv1beta1.Timestamp
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (string, *typesv1beta1.Timestamp, error)); ok {
		return rf(ctx, lockID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) string); ok {
		r0 = rf(ctx, lockID)
	...
	if rf, ok := ret.Get(1).(func(context.Context, string) *typesv1beta1.Timestamp); ok {
		r1 = rf(ctx, lockID)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*typesv1beta1.Timestamp)
...
func (_c *FileConnectorService_RefreshLock_Call) Return(_a0 string, _a1 *typesv1beta1.Timestamp, _a2 error) *FileConnectorService_RefreshLock_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}
...
func (_m *FileConnectorService) UnLock(ctx context.Context, lockID string) (string, *typesv1beta1.Timestamp, error) {
	ret := _m.Called(ctx, lockID)
...
func (_c *FileConnectorService_UnLock_Call) Return(_a0 string, _a1 *typesv1beta1.Timestamp, _a2 error) *FileConnectorService_UnLock_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}
