...
type Wopi struct {
	...
	EnableMobile bool   `yaml:"enable_mobile" env:"COLLABORATION_WOPI_ENABLE_MOBILE" desc:"Enable the mobile web view for office app. This feature applies to OnlyOffice." introductionVersion:"Balch"`
