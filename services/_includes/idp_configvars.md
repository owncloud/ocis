...
| IDP_SIGNING_PRIVATE_KEY_FILES | []string | [~/.ocis/idp/private-key.pem] | A list of private key files for signing IDP requests. If not defined, the root directory derives from $OCIS_BASE_DATA_PATH:/idp. See the Environment Variable Types description for more details.|
