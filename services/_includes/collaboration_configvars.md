...
|------|------|---------------|-------------|
| COLLABORATION_APP_NAME | string | Collabora Online | The name of the app|
| COLLABORATION_APP_DESCRIPTION | string | Open office documents with Collabora Online | App description|
...
| OCIS_JWT_SECRET<br/>COLLABORATION_JWT_SECRET | string | XGwA0tK7nFOq0Ga746EaJDIHa89atPGY | Used as JWT token and to encrypt access token.|
