...
| SHARING_EVENTS_TLS_ROOT_CA_CERTIFICATE<br/>SHARING_EVENTS_TLS_ROOT_CA_CERT | string |  | The root CA certificate used to validate the server's TLS certificate. If provided SHARING_EVENTS_TLS_INSECURE will be seen as false.|
