...
| OCIS_LDAP_SERVER_WRITE_ENABLED<br/>GRAPH_LDAP_SERVER_WRITE_ENABLED | bool | true | Allow to create, modify and delete LDAP users via the GRAPH API. This is only works when the default Schema is used.|
