...
| FRONTEND_APP_HANDLER_SECURE_VIEW_APP | string | Collabora Online | Name of the app to use for secure view. Should match COLLABORATION_APP_NAME, the name configured for the CS3 app provider.|
