...
| OCIS_CACHE_DISABLE_PERSISTENCE<br/>GATEWAY_STAT_CACHE_DISABLE_PERSISTENCE | bool | false | Disables persistence of the stat cache. Only applies when store type 'nats-js-kv' is configured. Defaults to false.|
