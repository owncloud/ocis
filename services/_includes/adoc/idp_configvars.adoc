...
pass:[]
a| [subs=-attributes]
pass:[The URI where a user can reset their password.]
...
pass:[127.0.0.1:9142]
a| [subs=-attributes]
pass:[CS3 gateway used to authenticate and look up users]
...
pass:[]
a| [subs=-attributes]
pass:[Serve IDP assets from a path on the filesystem instead of the builtin assets.]
...
a| [subs=-attributes]
pass:[The OIDC issuer URL to use.]
...
pass:[ldap]
a| [subs=-attributes]
pass:[The identity manager implementation to use, defaults to 'ldap', can be changed to 'cs3', 'kc', 'libregraph', 'cookie' or 'guest'.]
...
pass:[]
a| [subs=-attributes]
pass:[Idp uri base path (defaults to "").]
...
pass:[false]
a| [subs=-attributes]
pass:[Allow insecure connections to the user backend (eg. LDAP, CS3 api, ...).]
...
pass:[false]
a| [subs=-attributes]
pass:[Allow guest clients to access ocis.]
...
pass:[false]
a| [subs=-attributes]
pass:[Allow dynamic client registration.]
...
a| [subs=-attributes]
pass:[Path to the encryption secret file, if unset, a new certificate will be autogenerated upon each restart, thus invalidating all existing sessions.]
...
pass:[private-key]
a| [subs=-attributes]
pass:[Value of the KID (Key ID) field which is used in created tokens to uniquely identify the signing-private-key.]
...
pass:[PS256]
a| [subs=-attributes]
pass:[Signing method of idp requests (e.g. PS256)]
...
pass:[]
a| [subs=-attributes]
pass:[Path to validation keys for idp requests.]
...
pass:[86400]
a| [subs=-attributes]
pass:[Expiration time for idp access token (in seconds).]
...
pass:[3600]
a| [subs=-attributes]
pass:[Expiration time for idp id tokens (in seconds).]
...
pass:[94608000]
a| [subs=-attributes]
pass:[Expiration time for refresh tokens (in seconds).]
...
pass:[0]
a| [subs=-attributes]
pass:[Expiration time for dynamic clients (in seconds).]
...
a| [subs=-attributes]
pass:[Url of the LDAP service to use as idp.]
...
a| [subs=-attributes]
pass:[Path to the tls cert for the ldap service.]
...
pass:[uid]
a| [subs=-attributes]
pass:[LDAP User attribute to use for login (e.g. uid).]
...
pass:[mail]
a| [subs=-attributes]
pass:[LDAP User email attribute (e.g. mail).]
...
pass:[displayName]
a| [subs=-attributes]
pass:[LDAP User name attribute (e.g. displayName).]
...
pass:[uid]
a| [subs=-attributes]
pass:[LDAP User uuid attribute (e.g. uid).]
...
pass:[text]
a| [subs=-attributes]
pass:[LDAP User uuid attribute type (e.g. text).]
...
pass:[inetOrgPerson]
a| [subs=-attributes]
pass:[LDAP User ObjectClass (e.g. inetOrgPerson).]
|===
