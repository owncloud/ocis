...
[#deprecation-note-2026-01-21-23-43-06]
[caption=]
...
| Deprecating in favor of a unified array with arbitrary attributes
| Balch
| next-prod
| UserSearchDisplayedAttributes
|===
...
xref:deprecation-note-2026-01-21-23-43-06[Deprecation Note]
a| [subs=-attributes]
++6.0.0 ++
a| [subs=-attributes]
++bool ++
