...
xref:deprecation-note-2023-04-27-10-19-52[Deprecation Note]
a| [subs=-attributes]
++string ++
a| [subs=-attributes]
++ ++
...
a|`OCIS_CACHE_STORE` +
`FRONTEND_OCS_RESOURCE_INFO_CACHE_STORE` +
...
`FRONTEND_OCS_RESOURCE_INFO_CACHE_STORE_NODES` +
...
a|`FRONTEND_OCS_RESOURCE_INFO_CACHE_TABLE` +
...
a|`OCIS_CACHE_SIZE` +
`FRONTEND_OCS_RESOURCE_INFO_CACHE_SIZE` +
