...
[#deprecation-note-2023-04-13-15-21-30]
[caption=]
...
a|`INVITATIONS_KEYCLOAK_BASE_PATH` +
...
a|`INVITATIONS_KEYCLOAK_CLIENT_ID` +
...
a|`INVITATIONS_KEYCLOAK_CLIENT_SECRET` +
...
a|`INVITATIONS_KEYCLOAK_CLIENT_REALM` +
...
a|`INVITATIONS_KEYCLOAK_USER_REALM` +
...
a|`INVITATIONS_KEYCLOAK_INSECURE_SKIP_VERIFY` +
