...
++false ++
a| [subs=-attributes]
Enable license check for edit. Needs to be enabled when using Microsoft365 with the business flow.
...
++false ++
a| [subs=-attributes]
Disable chat in the frontend. This feature is available in OnlyOffice and Microsoft.
...
++ ++
a| [subs=-attributes]
The URL to the ownCloud Office365 WOPI proxy. Optional. To use this feature, you need an office365 proxy subscription. If you become part of the Microsoft CSP program (\https://learn.microsoft.com/en-us/partner-center/enroll/csp-overview), you can use the WebOffice without a proxy.
...
++ ++
a| [subs=-attributes]
The secret to authenticate against the ownCloud Office365 WOPI proxy. Optional. This secret can be obtained from ownCloud via the office365 proxy subscription.
