...
++false ++
a| [subs=-attributes]
Enables space management through OIDC claims.
...
++ ++
a| [subs=-attributes]
The name of the claim used for space management.
...
++ ++
a| [subs=-attributes]
The regular expression that extracts spaceid and role from a claim.
