...
pass:[true]
a| [subs=-attributes]
pass:[Disable TLS certificate validation for connections to the IDP. (not recommended for production environments.]
...
pass:[1024]
a| [subs=-attributes]
pass:[Cache size for oidc user info.]
...
pass:[10]
a| [subs=-attributes]
pass:[Max TTL for the oidc user info cache.]
...
pass:[true]
a| [subs=-attributes]
pass:[Allow ocs to get a signing key to sign requests.]
...
pass:[cs3]
a| [subs=-attributes]
pass:[Account backend the proxy should use, currenly only 'cs3' is possible here.]
...
pass:[email]
a| [subs=-attributes]
pass:[The name of an OpenID Connect claim that should be used for resolving users with the account backend. Currently defaults to 'email'.]
...
pass:[mail]
a| [subs=-attributes]
pass:[The name of a CS3 user attribute (claim) that should be mapped to the 'user_oidc_claim'. Currently defaults to 'mail' (other possible values are: 'username', 'displayname')]
...
pass:[false]
a| [subs=-attributes]
pass:[Set this to 'true' to automatically provsion users that do not yet exist in the users service on-demand upon first signin. To use this a write-enabled libregraph user backend needs to be setup an running.]
...
pass:[false]
a| [subs=-attributes]
pass:[Set this to true to enable 'basic' (username/password) authentication.]
...
pass:[false]
a| [subs=-attributes]
pass:[Disable TLS certificate validation for all http backend connections.]
|===
