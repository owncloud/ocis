...
[#deprecation-note-2026-02-02-12-54-35]
[caption=]
...
++0 ++
a| [subs=-attributes]
Part size for concurrent uploads to S3. If no value or 0 is set, the library's default value of 16MB is used. The value range is min 5MB and max 5GB.
