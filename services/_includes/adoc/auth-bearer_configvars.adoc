...
pass:[false]
a| [subs=-attributes]
pass:[Allow insecure connections to the OIDC issuer.]
...
a| [subs=-attributes]
pass:[Name of the claim, which holds the user identifier.]
...
pass:[]
a| [subs=-attributes]
pass:[Name of the claim, which holds the UID.]
...
pass:[]
a| [subs=-attributes]
pass:[Name of the claim, which holds the GID.]
|===
