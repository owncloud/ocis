...
++ ++
a| [subs=-attributes]
++Go micro registry type to use. Supported types are: 'nats', 'kubernetes', 'etcd', 'consul', 'memory' and 'mdns'. Will be selected automatically. Only change under supervision of ownCloud Support. ++
