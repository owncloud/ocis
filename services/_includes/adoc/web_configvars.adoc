...
[#deprecation-note-2024-05-20-04-40-24]
[caption=]
...
a|`WEB_ASSET_PATH` +
xref:deprecation-note-2024-05-20-04-40-24[Deprecation Note]
a| [subs=-attributes]
++string ++
a| [subs=-attributes]
++ ++
...
a| [subs=-attributes]
Serve ownCloud Web apps assets from a path on the filesystem instead of the builtin assets.
