...
[#deprecation-note-2023-11-14-00-39-33]
[caption=]
...
++true ++
a| [subs=-attributes]
Make a call to the oidc userinfo endpoint of the idp. For on premise AD FS this must be set to 'false'. The default is 'true'.
