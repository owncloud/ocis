...
[#deprecation-note-2023-12-11-08-08-44]
[caption=]
...
++false ++
a| [subs=-attributes]
Defines whether one ore more filters must be set in order to list users in the Web admin settings. Set this option to 'true' if running in an environment with a lot of users and listing all users could slow down performance. Defaults to 'false'.
