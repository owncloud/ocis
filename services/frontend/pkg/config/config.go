...
type OCS struct {
	...
	ResourceInfoCacheDatabase            string             `yaml:"resource_info_cache_database" env:"FRONTEND_OCS_RESOURCE_INFO_CACHE_DATABASE" desc:"The database name the configured store should use."`
