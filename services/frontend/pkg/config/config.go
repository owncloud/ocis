...
type OCS struct {
	...
	StatCacheDatabase           string        `yaml:"stat_cache_database" desc:"The database name the configured store should use." introductionVersion:"pre5.0" deprecationVersion:"7.0.0" removalVersion:"%%NEXT_PRODUCTION_VERSION%%" deprecationInfo:"The use of OCIS_CACHE_DATABASE in the frontend service is deprecated because the OCS API is deprecated" deprecationReplacement:""`
