...
type Config struct {
	...
	Driver  string  `yaml:"driver" env:"USERS_DRIVER" desc:"The authentication manager to check if credentials are valid. Supported values are 'ldap' and 'owncloudsql'."`
