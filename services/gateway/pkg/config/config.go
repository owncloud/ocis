...
type Config struct {
	...
	StorageKiteworksEndpoint     string `yaml:"storage_kiteworks_endpoint" env:"GATEWAY_STORAGE_KITEWORKS_ENDPOINT" desc:"The endpoint of the storage-users-kiteworks service. Leave empty to disable Kiteworks storage." introductionVersion:"pre5.0"`
	StorageKiteworksMountID      string `yaml:"storage_kiteworks_mount_id" env:"GATEWAY_STORAGE_KITEWORKS_MOUNT_ID" desc:"Mount ID reported by the storage-users-kiteworks service. Must match STORAGE_USERS_MOUNT_ID of that instance." introductionVersion:"pre5.0"`
