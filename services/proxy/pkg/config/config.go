...
type Config struct {
	...
	AuthenticationMiddleware AuthenticationMiddleware `yaml:"authentication_middleware"`
	AuthorizationMiddleware  AuthorizationMiddleware  `yaml:"authorization_middleware"`
...
// RouteType defines the route type
...
// AuthenticationMiddleware configures the proxy http authentication middleware.
