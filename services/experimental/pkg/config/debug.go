...
type Debug struct {
	Addr   string `ocisConfig:"addr" env:"EXPERIMENTAL_DEBUG_ADDR" desc:"Bind address of the debug server, where metrics, health, config and debug endpoints will be exposed."`
