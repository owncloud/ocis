...
// ListPermissions provides a mock function with given fields: ctx, itemID, listFederatedRoles
func (_m *DriveItemPermissionsProvider) ListPermissions(ctx context.Context, itemID *providerv1beta1.ResourceId, listFederatedRoles bool) (libregraph.CollectionOfPermissionsWithAllowedValues, error) {
	ret := _m.Called(ctx, itemID, listFederatedRoles)
	...
	if rf, ok := ret.Get(0).(func(context.Context, *providerv1beta1.ResourceId, bool) (libregraph.CollectionOfPermissionsWithAllowedValues, error)); ok {
		return rf(ctx, itemID, listFederatedRoles)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *providerv1beta1.ResourceId, bool) libregraph.CollectionOfPermissionsWithAllowedValues); ok {
		r0 = rf(ctx, itemID, listFederatedRoles)
	} else {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *providerv1beta1.ResourceId, bool) error); ok {
		r1 = rf(ctx, itemID, listFederatedRoles)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *DriveItemPermissionsProvider_Expecter) ListPermissions(ctx interface{}, itemID interface{}, listFederatedRoles interface{}) *DriveItemPermissionsProvider_ListPermissions_Call {
	return &DriveItemPermissionsProvider_ListPermissions_Call{Call: _e.mock.On("ListPermissions", ctx, itemID, listFederatedRoles)}
}

func (_c *DriveItemPermissionsProvider_ListPermissions_Call) Run(run func(ctx context.Context, itemID *providerv1beta1.ResourceId, listFederatedRoles bool)) *DriveItemPermissionsProvider_ListPermissions_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DriveItemPermissionsProvider_ListPermissions_Call) RunAndReturn(run func(context.Context, *providerv1beta1.ResourceId, bool) (libregraph.CollectionOfPermissionsWithAllowedValues, error)) *DriveItemPermissionsProvider_ListPermissions_Call {
	_c.Call.Return(run)
	return _c
}
