...
// Integration tests: NewLDAPWithReconnect → NewLDAPBackend → the libregraph/idm boltdb
// LDAP server oCIS ships (services/idm). Baseline for GetUser(s), CreateUser, DeleteUser.
