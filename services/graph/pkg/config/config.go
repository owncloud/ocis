...
type Validation struct {
	MaxTagLength int `yaml:"max_tag_length" env:"OCIS_MAX_TAG_LENGTH" desc:"The maximum length of a tag." introductionVersion:"%%NEXT%%"`
}
