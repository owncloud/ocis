...
type API struct {
	...
	ShowUserEmailInResults  bool   `yaml:"show_email_in_results" env:"GRAPH_SHOW_USER_EMAIL_IN_RESULTS;OCIS_SHOW_USER_EMAIL_IN_RESULTS" desc:"Mask user email addresses in responses." introductionVersion:"5.1"`
}
