...
type OCISDriver struct {
	...
	MaxConcurrency          int    `yaml:"max_concurrency" env:"STORAGE_USERS_OCIS_MAX_CONCURRENCY" desc:"Maximum number of concurrent goroutines. Higher values can cause more load on the system but potentially get work done faster. Values of 0 or below will be ignored and the default value of 100 will be used."`
...
type S3NGDriver struct {
	...
	MaxConcurrency          int    `yaml:"max_concurrency" env:"STORAGE_USERS_S3NG_MAX_CONCURRENCY" desc:"Maximum number of concurrent goroutines. Higher values can cause more load on the system but potentially get work done faster. Values of 0 or below will be ignored and the default value of 100 will be used."`
}
