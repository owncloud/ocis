...
type Cache struct {
	...
	Database string   `yaml:"database" env:"STORAGE_USERS_CACHE_DATABASE" desc:"(optional) The database name the configured store should use. This has no effect when the 'memory' store is configured."`
}
