...
type PosixDriver struct {
	...
	WatchMountPoint         string `yaml:"watch_mount_point" env:"STORAGE_USERS_POSIX_WATCH_MOUNT_POINT" desc:"The local path where the posixfs file system is mounted. Paths from events will be considered relative to this path." introductionVersion:"6.0.0"`
