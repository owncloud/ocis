...
type mockConstructorTestingTNewIndexClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewIndexClient creates a new instance of IndexClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewIndexClient(t mockConstructorTestingTNewIndexClient) *IndexClient {
	mock := &IndexClient{}
	mock.Mock.Test(t)
