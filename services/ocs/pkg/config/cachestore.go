...
type CacheStore struct {
	...
	Database  string        `yaml:"database" env:"OCS_CACHE_STORE_DATABASE" desc:"The database name the configured store should use. This has no effect when 'in-memory' stores or 'redis' is configured."`
	Table     string        `yaml:"table" env:"OCS_CACHE_STORE_TABLE" desc:"The database table the store should use. This has no effect when 'in-memory' stores are configured."`
