...
class FeatureContext extends BehatVariablesContext {
	...
	/**
	 * The base URL of the owncloud server under test,
	 * without any terminating slash
	 * e.g. http://localhost:8080
	 *
	 * @var string
	...
	public function __construct(
		...
		if ($oC10ServerUrl !== false) {
			$this->oC10BaseUrl = \rtrim($oC10ServerUrl, '/');
		}
	 ...
	 * @return string
	 */
	public function getOC10BaseUrl(): string {
		return $this->oC10BaseUrl;
	}
