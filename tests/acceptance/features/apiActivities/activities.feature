Feature: check activities
  ...
  Scenario: check activities of destination folder after moving a file into it
    Given user "Alice" has uploaded file with content "ownCloud test text file" to "textfile.txt"
    And user "Alice" has created folder "/FOLDER"
  ...
  Scenario: check activities of destinaton file and folder after moving a 0 byte file into it
  ...
  Scenario: check activities of destinaton file and folder after moving a file by renaming destination file
    Given user "Alice" has uploaded file with content "ownCloud test text file" to "textfile.txt"
    And user "Alice" has created folder "/FOLDER"
  ...
  Scenario: check activities of destinaton file and folder after moving a 0 byte file by renaming destination file
    Given user "Alice" has uploaded file "filesForUpload/zerobyte.txt" to "/zerobyte.txt"
    And user "Alice" has created folder "/FOLDER"
