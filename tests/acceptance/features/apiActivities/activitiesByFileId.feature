Feature: check activities
  ...
  Scenario Outline: check add activity for a file using file-id
    Given user "Alice" has uploaded file with content "ownCloud test text file 0" to "/textfile.txt"
    And we save it into "FILEID"
    And user "Alice" has created folder "/New Folder"
    And user "Alice" has copied a file "/textfile.txt" into "New Folder" inside space "Personal" using file-id path "<dav-path>"
  ...
  Scenario Outline: check edit activity for a file using file-id
    Given user "Alice" has uploaded file with content "ownCloud test text file 0" to "/textfile.txt"
    And we save it into "FILEID"
    And user "Alice" has sent HTTP method "PUT" to URL "<dav-path>" with content "updated content"
  ...
  @issue-9744
  Scenario Outline: check rename activity for a file using file-id
    Given user "Alice" has uploaded file with content "ownCloud test text file 0" to "/textfile.txt"
    And we save it into "FILEID"
    And user "Alice" has renamed a file "/textfile.txt" into "renamed.txt" inside space "Personal" using file-id path "<dav-path>"
  ...
  Scenario Outline: check move activity for a file using file-id
    Given user "Alice" has uploaded file with content "ownCloud test text file 0" to "/textfile.txt"
    And we save it into "FILEID"
    And user "Alice" has created folder "/New Folder"
    And user "Alice" has moved a file "/textfile.txt" into "New Folder" inside space "Personal" using file-id path "<dav-path>"
