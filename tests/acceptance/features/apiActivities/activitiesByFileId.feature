Feature: check activities
  ...
  Scenario: check activities of destination file and folder after uploading a file using file-id
    Given user "Alice" has created folder "NewFolder"
    And user "Alice" has uploaded file with content "test" to "NewFolder/textfile.txt"
