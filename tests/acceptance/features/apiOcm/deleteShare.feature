...
Feature: delete ocm share
  ...
  Scenario Outline: deleting ocm share should delete share on both instances (Personal Space)
  ...
  Scenario Outline: deleting ocm share should delete share on both instances (Project Space)
