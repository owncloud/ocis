...
Feature: delete ocm share
  ...
  Scenario Outline: deleting federated share should delete share on both instances (Personal Space)
  ...
  Scenario Outline: deleting federated share should delete share on both instances (Project Space)
