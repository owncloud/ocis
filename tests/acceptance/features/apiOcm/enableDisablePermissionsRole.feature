@ocm @env-config @issue-10824 @issue-10822
Feature: enable/disable permissions role
  ...
  Scenario: user access federated shared file shared with permissions role Secure Viewer after the role is disabled (Personal Space)
  ...
  Scenario: user access federated shared folder shared with permissions role Secure Viewer after the role is disabled (Personal Space)
  ...
  Scenario: user access federated shared file shared with permissions role Secure Viewer after the role is disabled (Project Space)
  ...
  Scenario: user access federated shared folder shared with permissions role Secure Viewer after the role is disabled (Project Space)
    Given the administrator has assigned the role "Space Admin" to user "Alice" using the Graph API
    And user "Alice" has created a space "new-space" with the default quota using the Graph API
