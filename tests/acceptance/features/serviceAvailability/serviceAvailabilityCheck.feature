Feature: service health check
  ...
  Scenario: health check defauts service
    When a user requests these endpoints with "GET"
      ...
      # | %base_url_without_scheme_and_port%/healthz      | activitylog        | #get 500                      |
      ...
      | %base_url_without_scheme_and_port%:9141/healthz | frontend           |         |
      ...
      | %base_url_without_scheme_and_port%:9234/healthz | invitations        |         |
      ...
      # | %base_url_without_scheme_and_port%:9281/healthz | ocm                | should not be used by default |
  ...
  Scenario: service ready check
    When a user requests these endpoints with "GET"
      ...
      | %base_url_without_scheme_and_port%:9141/readyz | frontend           |         |
      ...
      | %base_url_without_scheme_and_port%:9234/readyz | invitations        |         |
  ...
  Scenario: health check extra services
    ...
    When a user requests these endpoints with "GET"
      | endpoint                                       | service  | comment |
      # | %base_url_without_scheme_and_port%:9229/readyz | audit    | #get 500 |
