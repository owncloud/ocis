...
Feature: enable disable permissions role
  ...
  Scenario: users list the folder shares shared with Editor role after the role is disabled (Personal Space)
    ...
    When user "Brian" uploads a file inside space "Shares" with content "updated content" to "folderToShare/textfile.txt" using the WebDAV API
    Then the HTTP status code should be "204"
    And for user "Alice" the content of the file "folderToShare/textfile.txt" of the space "Personal" should be "updated content"
    And for user "Brian" the content of the file "folderToShare/textfile.txt" of the space "Shares" should be "updated content"
  ...
  Scenario: users list the folder shares shared with Editor role after the role is disabled (Project Space)
    ...
    When user "Brian" uploads a file inside space "Shares" with content "updated content" to "folderToShare/textfile.txt" using the WebDAV API
    Then the HTTP status code should be "204"
    And for user "Alice" the content of the file "folderToShare/textfile.txt" of the space "new-space" should be "updated content"
    And for user "Brian" the content of the file "folderToShare/textfile.txt" of the space "Shares" should be "updated content"
  ...
  Scenario: users list the file shares shared with Editor role after the role is disabled (Personal Space)
    ...
    And as user "Brian" the PROPFIND response should contain a resource "textfile.txt" with these key and value pairs:
      ...
      | oc:permissions | SNVW         |
    When user "Brian" uploads a file inside space "Shares" with content "updated content" to "textfile.txt" using the WebDAV API
    Then the HTTP status code should be "204"
