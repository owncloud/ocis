Feature: an user gets the resources shared to them
  ...
  @env-config
  Scenario: sharee lists the file share shared with "FileEditorListGrantsWithVersions" permission role (Personal Space)
    Given the administrator has enabled the permissions role "File Editor List Grants With Versions"
    And user "Alice" has uploaded file with content "hello world" to "textfile.txt"
    And user "Alice" has sent the following resource share invitation:
      | resource        | textfile.txt                          |
      | space           | Personal                              |
  ...
  @env-config
  Scenario: sharee lists the file share shared with "FileEditorListGrantsWithVersions" permission role (Project Space)
    Given using spaces DAV path
    And the administrator has enabled the permissions role "File Editor List Grants With Versions"
    And the administrator has assigned the role "Space Admin" to user "Alice" using the Graph API
    And user "Alice" has created a space "new-space" with the default quota using the Graph API
    And user "Alice" has uploaded a file inside space "new-space" with content "some content" to "testfile.txt"
    And user "Alice" has sent the following resource share invitation:
  ...
  @env-config
  Scenario: sharee lists the folder share shared with "EditorListGrantsWithVersions" permission role
    Given the administrator has enabled the permissions role "Editor List Grants With Versions"
    And user "Alice" has created folder "folder"
    And user "Alice" has sent the following resource share invitation:
      | resource        | folder                           |
      | space           | Personal                         |
  ...
  @env-config
  Scenario: sharee lists the folder share shared with "EditorListGrantsWithVersions" permission role (Project Space)
    Given using spaces DAV path
    And the administrator has enabled the permissions role "Editor List Grants With Versions"
    And the administrator has assigned the role "Space Admin" to user "Alice" using the Graph API
    And user "Alice" has created a space "new-space" with the default quota using the Graph API
    And user "Alice" has created a folder "folder" in space "new-space"
    And user "Alice" has sent the following resource share invitation:
