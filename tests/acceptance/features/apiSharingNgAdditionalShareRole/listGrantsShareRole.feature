...
Feature: ListGrants role
  ...
  Scenario: user lists permissions of a folder after enabling 'Viewer With ListGrants' role
  ...
  Scenario: user lists permissions of a folder after enabling 'File Editor With ListGrants' role (Project space)
