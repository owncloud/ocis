...
Feature: an user shares resources
  As a user
  I don't want space editor to acess deleted files
  So that they cant restore them
  ...
  Scenario: sharee checks trashbin after file is deleted
    ...
    And user "Alice" has removed the file "textfile.txt" from space "new-space"
    When user "Brian" with admin permission lists all deleted files in the trash bin of the space "new-space"
