Feature: Search
  ...
  Scenario Outline: user can search items from root of the project space
    ...
    When user "Alice" searches for "*inside*" in space "project101" using the WebDAV API
  ...
  Scenario Outline: user can search items from root of the personal space
    Given using <dav-path-version> DAV path
    And user "Alice" has created a folder "AlicePersonal" in space "Personal"
    And user "Alice" has uploaded a file inside space "Personal" with content "inside Alice personal space" to "AlicePersonal/insideAlicePersonal.txt"
    And user "Brian" has created a folder "BrianPersonal" in space "Personal"
    ...
    And user "Brian" has sent the following resource share invitation:
      ...
      | permissionsRole | Viewer        |
    And user "Alice" has a share "BrianPersonal" synced
    When user "Alice" searches for "*inside*" in space "Personal" using the WebDAV API
    Then the HTTP status code should be "207"
    And the search result should contain "1" entries
  ...
  Scenario Outline: user cannot search items from root of the shares space
    Given using <dav-path-version> DAV path
    And user "Alice" has created a folder "AlicePersonal" in space "Personal"
    And user "Alice" has uploaded a file inside space "Personal" with content "inside Alice personal space" to "AlicePersonal/insideAlicePersonal.txt"
    And user "Brian" has created a folder "BrianPersonal" in space "Personal"
    ...
    And user "Brian" has sent the following resource share invitation:
      ...
      | permissionsRole | Viewer        |
    And user "Alice" has a share "BrianPersonal" synced
    When user "Alice" searches for "*inside*" in space "Shares" using the WebDAV API
    Then the HTTP status code should be "207"
