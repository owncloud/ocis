...
class AuthAppContext implements Context {
	...
	/**
	 * @When the administrator creates user :user using the auth-app token
	 *
	 * @param string $user
	 *
	 * @return void
	...
	/**
	 * @When user :user lists all her/his drives using the auth-app token
	 *
	 * @param string $user
	 *
	 * @return void
	 */
	public function userListsAllHerDrivesUsingTheAuthAppToken(string $user): void {
		$this->featureContext->setResponse(
