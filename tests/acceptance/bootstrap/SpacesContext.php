...
class SpacesContext implements Context {
	...
	/**
	 * @When /^user "([^"]*)" creates a (?:folder|subfolder) "([^"]*)" inside federated share "([^"]*)" using the WebDav Api$/
	 *
	 * @param string $user
	 * @param string $folder
	 ...
	 * @throws GuzzleException
	 */
	public function theUserCreatesAFolderInsideFederatedShareUsingTheWebDavApi(
		string $user,
		string $folder,
