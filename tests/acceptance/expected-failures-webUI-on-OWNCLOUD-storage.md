...
This issue has been fixed. The following scenario was a bug-demonstration scenario for the problem.
So it is now "failing". The scenario will be removed from the webUI test suite in the next update.

-   [webUITrashbinDelete/trashbinDelete.feature:121](https://github.com/owncloud/web/blob/master/tests/acceptance/features/webUITrashbinDelete/trashbinDelete.feature#L121)
