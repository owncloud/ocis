...
// NewGatewayAPIClient creates a new instance of GatewayAPIClient. It also registers a cleanup function to assert the mocks expectations.
func NewGatewayAPIClient(t testing.TB) *GatewayAPIClient {
