...
var _ = Describe("Graph", func() {
	...
	Describe("drive", func() {
		...
		It("can list a spaces with sort on lastModifiedDateTime", func() {
			gatewayClient.On("ListStorageSpaces", mock.Anything, mock.Anything).Return(&provider.ListStorageSpacesResponse{
				Status: status.NewOK(ctx),
				StorageSpaces: []*provider.StorageSpace{
					{
						...
						Name:  "bspacename",
						Mtime: &types.Timestamp{Seconds: 1645218201, Nanos: 0},
					},
					{
						Id:        &provider.StorageSpaceId{OpaqueId: "aspaceid"},
						SpaceType: "aspacetype",
						...
						Name:  "aspacename",
						Mtime: &types.Timestamp{Seconds: 1645219201, Nanos: 0},
					},
				},
			}, nil)
			gatewayClient.On("InitiateFileDownload", mock.Anything, mock.Anything).Return(&gateway.InitiateFileDownloadResponse{
			...
			r := httptest.NewRequest(http.MethodGet, "/graph/v1.0/me/drives?$orderby=lastModifiedDateTime%20desc", nil)
			rr := httptest.NewRecorder()
			svc.GetDrives(rr, r)
				...
				"value":[
					{
						"driveType":"aspacetype",
						"id":"aspaceid",
                        "lastModifiedDateTime": "2022-02-18T22:20:01+01:00",
						"name":"aspacename",
						"root":{
							"id":"aspaceid!anopaqueid",
							"webDavUrl":"https://localhost:9200/dav/spaces/aspaceid"
					...
					},
					{
						"driveType":"bspacetype",
						"id":"bspaceid",
                        "lastModifiedDateTime": "2022-02-18T22:03:21+01:00",
						"name":"bspacename",
						"root":{
							"id":"bspaceid!bopaqueid",
							"webDavUrl":"https://localhost:9200/dav/spaces/bspaceid"
