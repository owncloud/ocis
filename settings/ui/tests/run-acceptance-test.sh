...
export EXTERNAL_STEP_DEFINITIONS="/drone/src/settings/ui/tests/acceptance/stepDefinitions"
export EXTERNAL_PAGE_OBJECTS="/drone/src/settings/ui/tests/acceptance/pageobjects"
